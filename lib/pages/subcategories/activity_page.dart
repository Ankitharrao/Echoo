...
class ActivityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> foodItems = [
      {"images": "assets/images/bath.png", "text": "Bath"},
      {"images": "assets/images/brush.png", "text": "Brush"},
      {"images": "assets/images/eat.png", "text": "Eat"},
      {"images": "assets/images/drink water.png", "text": "Drink water"},
      {"images": "assets/images/play.png", "text": "Play"},
      {"images": "assets/images/sleep.png", "text": "Sleep"},
    ];
